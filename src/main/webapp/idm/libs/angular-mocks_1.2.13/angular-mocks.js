 ...
 *
  ...
  function MyController($scope, $http) {
    ...
    $scope.saveMessage = function(message) {
      ...
      $http.post('/add-msgConfig.py', message, { headers: headers } ).success(function(response) {
        $scope.status = '';
      }).error(function() {
        $scope.status = 'ERROR!';
      });
 ...
 *
  <pre>
    ...
    describe('MyController', function() {
       ...
       it('should send msgConfig to server', function() {
         var controller = createController();
         $httpBackend.flush();
         ...
         $httpBackend.expectPOST('/add-msgConfig.py', 'message content').respond(201, '');
       ...
       it('should send auth header', function() {
         ...
         $httpBackend.expectPOST('/add-msgConfig.py', undefined, function(headers) {
