...
CREATE TABLE `right_def_info` (
  `RIGHTDEFID` bigint(20) NOT NULL COMMENT '主键id',
  `RIGHTINDEX` varchar(10) DEFAULT NULL COMMENT '权限索引编号',
  `RIGHTNAME` varchar(255) DEFAULT NULL COMMENT '权限名称',
  `rightType` int(5) DEFAULT NULL COMMENT '权限类型（1：站点，2：栏目，3：栏目文档，4：公司，5：文档，6：菜单，7：模板）',
  `RIGHTDESC` varchar(255) DEFAULT NULL COMMENT '描述说明',
  `SYSDEFINED` int(5) DEFAULT NULL COMMENT '是否系统预定义权限',
  `CRUSER` varchar(255) DEFAULT NULL COMMENT '创建人姓名',
  `CRNUMBER` bigint(20) DEFAULT NULL COMMENT '创建人id',
  `CRTIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_by` bigint(20) DEFAULT NULL COMMENT '最后修改人id',
  `modify_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  PRIMARY KEY (`RIGHTDEFID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='权限管理表';

--授权关联表
CREATE TABLE `right_info` (
  `RIGHTID` bigint(20) NOT NULL COMMENT '主键id',
  `OBJTYPE` int(5) DEFAULT NULL COMMENT '对象类型',
  `OBJID` bigint(20) DEFAULT NULL COMMENT '所属对象编号',
  `limitType` varchar(255) DEFAULT NULL COMMENT '权限类型',
  `OPRTYPE` bigint(20) DEFAULT NULL COMMENT '操作类型',
  `OPRIDTYPE` int(5) DEFAULT NULL COMMENT '操作对象名称类型',
  `OPRID` varchar(255) DEFAULT NULL COMMENT '操作对象id',
